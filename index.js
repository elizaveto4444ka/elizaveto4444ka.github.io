...
function startGame() {
    //Задает размерность поля, считывая по айди введенное значение в input
...
//Создание разметки таблицы под введенное demention
...
//Проверка победителя по вертикали, горизонтали и диагонали, закрашивание и вывод диалогового окна.
function checkWinner(gameField) {
    ...
    //Закрашивание в красный победителя
...
function cellClickHandler(row, col) {
    if (gameField[row][col] === EMPTY && clickCounter <= possibleClicksCount) {
        // let fieldState = CROSS;     // Второй вариант игры, где ты ставишь крестик, а компьютер нолик 
